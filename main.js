...
var setup=()=>{
    ...
    balls.push(new Ball(innerWidth/2, innerHeight-(innerHeight/10),longSide/30))
    paddle=new Paddle()
    frameRate(12)
    edges.push(new Sprite(width+width/2,height/2,width,height*2),new Sprite(0-width/2,height/2,width,height*2),new Sprite(width/2,0-height/2,width*2,height))
    edges.forEach(edge => {
